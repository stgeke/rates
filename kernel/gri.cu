...
__device__ void gibbs(double * species, const double * tc)
{
...
__device__ void productionRate(double * wdot, double * sc, double T)
{
    ...
    const double tc[] = { log(T), T, T*T, T*T*T, T*T*T*T, 1*tc[5]}; /*temperature cache */

    /*reference concentration: P_atm / (RT) in inverse mol/m^3 */

    const double refC = 1.01325000e+05 / 8.314621000e+00 * tc[5];
    const double inv_refC = 1/refC;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[4];
    Kc = refC * exp((g_RT[2] + g_RT[1]) - (g_RT[4]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[2] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[15];
    Kc = refC * exp((g_RT[2] + g_RT[14]) - (g_RT[15]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[2] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[2] + g_RT[27]) - (g_RT[1] + 2 * g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[2] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[6];
    Kc = refC * exp((g_RT[1] + g_RT[3]) - (g_RT[6]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[6]*sc[3];
    Kc = refC * exp((g_RT[1] + 2 * g_RT[3]) - (g_RT[6] + g_RT[3]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[6]*sc[5];
    Kc = refC * exp((g_RT[1] + g_RT[3] + g_RT[5]) - (g_RT[6] + g_RT[5]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[6]*sc[47];
    Kc = refC * exp((g_RT[1] + g_RT[3] + g_RT[47]) - (g_RT[6] + g_RT[47]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[6]*sc[48];
    Kc = refC * exp((g_RT[1] + g_RT[3] + g_RT[48]) - (g_RT[6] + g_RT[48]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[0]*sc[0];
    Kc = refC * exp((2 * g_RT[1] + g_RT[0]) - (2 * g_RT[0]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= 2 * qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[0]*sc[5];
    Kc = refC * exp((2 * g_RT[1] + g_RT[5]) - (g_RT[0] + g_RT[5]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= 2 * qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[0]*sc[15];
    Kc = refC * exp((2 * g_RT[1] + g_RT[15]) - (g_RT[0] + g_RT[15]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= 2 * qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((4.380000e-01*exp(T/-9.100000e+01))+ (5.620000e-01*exp(T/-5.836000e+03))+ (exp(-8.552000e+03*tc[5])));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[12];
    Kc = refC * exp((g_RT[1] + g_RT[10]) - (g_RT[12]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.170000e-01*exp(T/-7.400000e+01))+ (7.830000e-01*exp(T/-2.941000e+03))+ (exp(-6.964000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[13];
    Kc = refC * exp((g_RT[1] + g_RT[12]) - (g_RT[13]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.176000e-01*exp(T/-2.710000e+02))+ (7.824000e-01*exp(T/-2.755000e+03))+ (exp(-6.570000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[17];
    Kc = refC * exp((g_RT[1] + g_RT[16]) - (g_RT[17]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.813000e-01*exp(T/-1.030000e+02))+ (7.187000e-01*exp(T/-1.291000e+03))+ (exp(-4.160000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[18];
    Kc = refC * exp((g_RT[1] + g_RT[17]) - (g_RT[18]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.420000e-01*exp(T/-9.400000e+01))+ (7.580000e-01*exp(T/-1.555000e+03))+ (exp(-4.200000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[19];
    Kc = refC * exp((g_RT[1] + g_RT[17]) - (g_RT[19]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((4.000000e-01*exp(T/-1.000000e+02))+ (6.000000e-01*exp(T/-9.000000e+04))+ (exp(-1.000000e+04*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[20];
    Kc = refC * exp((g_RT[1] + g_RT[18]) - (g_RT[20]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((3.000000e-01*exp(T/-1.000000e+02))+ (7.000000e-01*exp(T/-9.000000e+04))+ (exp(-1.000000e+04*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[20];
    Kc = refC * exp((g_RT[1] + g_RT[19]) - (g_RT[20]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((3.536000e-01*exp(T/-1.320000e+02))+ (6.464000e-01*exp(T/-1.315000e+03))+ (exp(-5.566000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.493000e-01*exp(T/-9.850000e+01))+ (7.507000e-01*exp(T/-1.302000e+03))+ (exp(-4.167000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[23];
    Kc = refC * exp((g_RT[1] + g_RT[22]) - (g_RT[23]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.180000e-01*exp(T/-2.075000e+02))+ (7.820000e-01*exp(T/-2.663000e+03))+ (exp(-6.095000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[24];
    Kc = refC * exp((g_RT[1] + g_RT[23]) - (g_RT[24]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.470000e-02*exp(T/-2.100000e+02))+ (9.753000e-01*exp(T/-9.840000e+02))+ (exp(-4.374000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[25];
    Kc = refC * exp((g_RT[1] + g_RT[24]) - (g_RT[25]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((1.578000e-01*exp(T/-1.250000e+02))+ (8.422000e-01*exp(T/-2.219000e+03))+ (exp(-6.882000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[26];
    Kc = refC * exp((g_RT[1] + g_RT[25]) - (g_RT[26]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((6.800000e-02*exp(T/-1.970000e+02))+ (9.320000e-01*exp(T/-1.540000e+03))+ (exp(-1.030000e+04*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.654000e-01*exp(T/-9.400000e+01))+ (7.346000e-01*exp(T/-1.756000e+03))+ (exp(-5.182000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((5.880000e-01*exp(T/-1.950000e+02))+ (4.120000e-01*exp(T/-5.900000e+03))+ (exp(-6.394000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[20];
    Kc = refC * exp((g_RT[4] + g_RT[12]) - (g_RT[20]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[4] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((4.243000e-01*exp(T/-2.370000e+02))+ (5.757000e-01*exp(T/-1.652000e+03))+ (exp(-5.069000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[27];
    Kc = refC * exp((g_RT[9] + g_RT[14]) - (g_RT[27]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[9] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((4.093000e-01*exp(T/-2.750000e+02))+ (5.907000e-01*exp(T/-1.226000e+03))+ (exp(-5.185000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[28];
    Kc = refC * exp((g_RT[10] + g_RT[14]) - (g_RT[28]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[10] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[11] + g_RT[3]) - (g_RT[1] + g_RT[4] + g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[11] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((3.973000e-01*exp(T/-2.080000e+02))+ (6.027000e-01*exp(T/-3.922000e+03))+ (exp(-1.018000e+04*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[20];
    Kc = refC * exp((g_RT[11] + g_RT[5]) - (g_RT[20]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[11] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((3.810000e-01*exp(T/-7.320000e+01))+ (6.190000e-01*exp(T/-1.180000e+03))+ (exp(-9.999000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    Kc = inv_refC * exp((g_RT[16] + g_RT[5]) - (g_RT[1] + g_RT[14] + g_RT[5]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[16] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[1]*sc[14];
    Kc = inv_refC * exp((g_RT[16]) - (g_RT[1] + g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[16] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((2.655000e-01*exp(T/-1.800000e+02))+ (7.345000e-01*exp(T/-1.035000e+03))+ (exp(-5.417000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[0]*sc[22];
    Kc = inv_refC * exp((g_RT[24]) - (g_RT[0] + g_RT[22]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[24] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[27] + g_RT[3]) - (g_RT[4] + 2 * g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[27] -= qdot;
    ...
    Kc = inv_refC * exp((2 * g_RT[27]) - (2 * g_RT[14] + g_RT[22]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[27] -= 2 * qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[47]*sc[2];
    Kc = inv_refC * exp((g_RT[37]) - (g_RT[47] + g_RT[2]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[37] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[36];
    Kc = refC * exp((g_RT[35] + g_RT[2]) - (g_RT[36]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[35] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[47]*sc[1];
    Kc = inv_refC * exp((g_RT[34]) - (g_RT[47] + g_RT[1]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[34] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[38];
    Kc = refC * exp((g_RT[1] + g_RT[35]) - (g_RT[38]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[46] + g_RT[4]) - (g_RT[35] + g_RT[1] + g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[46] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[30]*sc[14];
    Kc = inv_refC * exp((g_RT[46]) - (g_RT[30] + g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[46] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[1]*sc[39];
    Kc = inv_refC * exp((g_RT[40]) - (g_RT[1] + g_RT[39]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[40] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[41];
    Kc = refC * exp((g_RT[1] + g_RT[40]) - (g_RT[41]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((3.330000e-01*exp(T/-2.350000e+02))+ (6.670000e-01*exp(T/-2.117000e+03))+ (exp(-4.536000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[42];
    Kc = refC * exp((g_RT[9] + g_RT[47]) - (g_RT[42]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[9] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[42] + g_RT[2]) - (g_RT[14] + g_RT[1] + g_RT[47]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[42] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[42] + g_RT[3]) - (g_RT[2] + g_RT[16] + g_RT[47]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[42] -= qdot;
    ...
    Kc = inv_refC * exp((g_RT[42] + g_RT[4]) - (g_RT[1] + g_RT[16] + g_RT[47]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[42] -= qdot;
    ...
    q_f = phi_f * k_f;
    phi_r = sc[31]*sc[14];
    Kc = inv_refC * exp((g_RT[45]) - (g_RT[31] + g_RT[14]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[45] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((4.220000e-01*exp(T/-1.220000e+02))+ (5.780000e-01*exp(T/-2.535000e+03))+ (exp(-9.365000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[12];
    Kc = refC * exp((g_RT[9] + g_RT[0]) - (g_RT[12]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[9] -= qdot;
    ...
    phi_f = sc[2]*sc[52];
    k_f = 1.000000e-06 * 2.920000e+12*exp(-9.098157e+02*tc[5]);
    q_f = phi_f * k_f;
    phi_r = sc[4]*sc[51];
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((5.350000e-01*exp(T/-2.010000e+02))+ (4.650000e-01*exp(T/-1.773000e+03))+ (exp(-5.333000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[51];
    Kc = refC * exp((g_RT[1] + g_RT[28]) - (g_RT[51]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((8.473000e-01*exp(T/-2.910000e+02))+ (1.527000e-01*exp(T/-2.742000e+03))+ (exp(-7.748000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[50];
    Kc = refC * exp((g_RT[12] + g_RT[25]) - (g_RT[50]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[12] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((8.106000e-01*exp(T/-2.770000e+02))+ (1.894000e-01*exp(T/-8.748000e+03))+ (exp(-7.891000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[49];
    Kc = refC * exp((g_RT[12] + g_RT[24]) - (g_RT[49]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[12] -= qdot;
    ...
    F = redP / (1 + redP);
    logPred = log10(redP);
    logFcent = log10((6.850000e-01*exp(T/-3.690000e+02))+ (3.150000e-01*exp(T/-3.285000e+03))+ (exp(-6.667000e+03*tc[5])));
    troe_c = -.4 - .67 * logFcent;
    troe_n = .75 - 1.27 * logFcent;
    troe = (troe_c + logPred) / (troe_n - .14*(troe_c + logPred));
    F_troe = pow(10, logFcent / (1.0 + troe*troe));
    ...
    q_f = phi_f * k_f;
    phi_r = sc[50];
    Kc = refC * exp((g_RT[1] + g_RT[49]) - (g_RT[50]));
    k_r = k_f * Kc;
    q_r = phi_r * k_r;
    qdot = q_f - q_r;
    wdot[1] -= qdot;
