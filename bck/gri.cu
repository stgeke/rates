...
__device__ void gibbs(double * species, double * tc)
{
...
__device__ void productionRate(double * wdot, double * sc, double T)
{
    double qdot;
...
extern "C" __global__ void mywxp_(const int N, double * P, double * T, double * x, double * wdot)
{
